...
class BlackPanther extends React.Component {
        ...
        return (
            <ScrollView style={{flex: 1, backgroundColor: '#231F20'}}>
                ...
                <View style={{ marginHorizontal: 10}}>
                    <Text style={styles.movieTitle}>Black Panther</Text>
                    <View style={{height: 180}}>
                        <WebView
                            style={{flex: 1}}
                            javaScriptEnabled
                            source={{
                                uri: 'https://www.youtube.com/embed/xjDjIWPwcPU?rel=0&autoplay=0&showinfo=0&controls=1'
                            }}
                        />
                    </View>
                    <Text style={[styles.listDesc, {marginVertical: 10, fontSize: 14}]}>
                        T'Challa, the King of Wakanda, rises to the throne in the
                        isolated, technologically advanced African nation
                    </Text>
