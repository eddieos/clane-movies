                    ...
                    <Header transparent>
                        <Left>
                            <Button transparent style={{paddingBottom: 4}}
                                ...
                                <Icon name="ios-arrow-dropleft-circle-outline"  style={{fontSize: 30, color: '#EEE6D9'}}/>
                            </Button>
                        </Left>
                ...
                <View style={{ marginHorizontal: 10}}>
                    ...
                    <View style={{height: 180}}>
                        <WebView
                            ...
                            javaScriptEnabled
                            source={{
                                uri: 'https://www.youtube.com/embed/i5qOzqD9Rms?rel=0&autoplay=0&showinfo=0&controls=1'
                            }}
                        />
                    </View>
                    <Text style={[styles.listDesc, {marginVertical: 10, fontSize: 14}]}>Bob Parr (Mr. Incredible) is left to care for the kids
                        while
                        Helen (Elastigirl) is out saving the world.</Text>

                        <Text style={[styles.listGenre, {fontSize: 12, marginBottom: 10}]}>Action | Animation | Comedy | Kids</Text>
